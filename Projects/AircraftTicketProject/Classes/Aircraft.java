...
public class Aircraft implements Serializable {
    ...
    private int business_class_capacity, economy_class_capacity;

    public Aircraft(Long id, String name, String model, int business_class_capacity, int economy_class_capacity) {
        this.id = id;
        this.name = name;
        this.model = model;
